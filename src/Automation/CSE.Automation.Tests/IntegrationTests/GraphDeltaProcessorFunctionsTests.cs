...
using CSE.Automation.Tests.IntegrationTests.TestCaseValidators;
using CSE.Automation.Tests.IntegrationTests.TestCaseValidators.ActivityResuts;
using CSE.Automation.Tests.IntegrationTests.TestCaseValidators.AuditResults;
...
using CSE.Automation.Tests.IntegrationTests.TestCaseValidators.ObjectTrackingResults;
using CSE.Automation.Tests.IntegrationTests.TestCaseValidators.ServicePrincipalResults;
...
namespace CSE.Automation.Tests.IntegrationTests
{
    public class GraphDeltaProcessorFunctionsTests
    {
        ...
        private void CreateServices()
        {
            ...
            _objectService = new ObjectTrackingService(_objectRespository, _objectTrackingServiceLogger);
