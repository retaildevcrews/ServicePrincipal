...
{
    internal class ObjectStateDefinition6 : ObjectStateDefinitionBase, IObjectStateDefinition
    {
        public ObjectStateDefinition6(ServicePrincipal servicePrincipal, ServicePrincipalModel servicePrincipalModel,
