...
namespace CSE.Automation.Tests.FunctionsUnitTests.TestCaseValidators.ActivityResults
{
    ...
    internal class ActivityResultValidator1_2 : ActivityResultValidatorBase, IActivityResultValidator
    {
        public ActivityResultValidator1_2(ActivityHistory savedActivityEntry, List<ActivityHistory> activityHistoryList, 
