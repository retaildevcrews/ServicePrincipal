...
namespace CSE.Automation.Tests.FunctionsUnitTests.TestCaseValidators.ActivityResults
{
    ...
    internal class ActivityResultValidator1 : ActivityResultValidatorBase, IActivityResultValidator
    {
        public ActivityResultValidator1(ActivityHistory savedActivityEntry, List<ActivityHistory> activityHistoryList, 
