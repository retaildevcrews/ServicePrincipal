...
{
    internal class SpStateDefinition2 : SpStateDefinitionBase, ISpStateDefinition
    {
        public SpStateDefinition2(ServicePrincipal servicePrincipal, TestCase testCase) : base(servicePrincipal, testCase)
        {
        }
