...
{
    internal class UpdateSpStateDefinition2 : SpStateDefinitionBase, ISpStateDefinition
    {
        public UpdateSpStateDefinition2(ServicePrincipal servicePrincipal, TestCase testCase) : base(servicePrincipal, testCase)
        {
        }
