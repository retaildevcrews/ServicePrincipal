...
{
    internal class UpdateSpStateDefinition1_2 : SpStateDefinitionBase, ISpStateDefinition
    {
        public UpdateSpStateDefinition1_2(ServicePrincipal servicePrincipal, TestCase testCase) : base(servicePrincipal, testCase)
        {
        }
