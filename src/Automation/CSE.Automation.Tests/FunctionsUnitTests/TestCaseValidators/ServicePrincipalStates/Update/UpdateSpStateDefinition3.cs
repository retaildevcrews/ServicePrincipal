...
{
    internal class UpdateSpStateDefinition3 : SpStateDefinitionBase, ISpStateDefinition
    {
        public UpdateSpStateDefinition3(ServicePrincipal servicePrincipal, TestCase testCase) : base(servicePrincipal, testCase)
        {
        }
